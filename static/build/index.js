...
(function($PS) {
  ...
  var navigateAppM = new Capability_Navigate.Navigate(function () {
      ...
      var $15 = Effect_Class.liftEffect(monadEffectAppM);
      var $16 = Routing_Duplex.print(Data_Route.routeCodec);
      return function ($17) {
          return $15(Routing_Hash.setHash($16($17)));
      };
  })());
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Component.HTML.Footer"] = $PS["Component.HTML.Footer"] || {};
  var exports = $PS["Component.HTML.Footer"];
  var Component_HTML_Utils = $PS["Component.HTML.Utils"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];                
  var footer = Halogen_HTML_Elements.div([ Component_HTML_Utils.css("footer") ])([ Halogen_HTML_Elements.ul([ Component_HTML_Utils.css("items") ])([ Halogen_HTML_Elements.li([ Component_HTML_Utils.css("item") ])([ Halogen_HTML_Elements.i([ Component_HTML_Utils.css("fas fa-phone") ])([  ]), Halogen_HTML_Core.text("S\xedmi: 6182195") ]) ]) ]);
  exports["footer"] = footer;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Data.Link"] = $PS["Data.Link"] || {};
  var exports = $PS["Data.Link"];
  var ExternalLink = (function () {
      function ExternalLink(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ExternalLink.create = function (value0) {
          return function (value1) {
              return new ExternalLink(value0, value1);
          };
      };
      return ExternalLink;
  })();
  var SafeLink = (function () {
      function SafeLink(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SafeLink.create = function (value0) {
          return function (value1) {
              return new SafeLink(value0, value1);
          };
      };
      return SafeLink;
  })();
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Component.HTML.Header"] = $PS["Component.HTML.Header"] || {};
  var exports = $PS["Component.HTML.Header"];
  var Component_HTML_Utils = $PS["Component.HTML.Utils"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Link = $PS["Data.Link"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Route = $PS["Data.Route"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  ...
  var HeaderLink = (function () {
      function HeaderLink(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HeaderLink.create = function (value0) {
          return function (value1) {
              return new HeaderLink(value0, value1);
          };
      };
      return HeaderLink;
  })();
  var header = function (links) {
      var renderLink = function (link) {
          var renderLinkChilds = function (s) {
              return function (icon) {
                  return [ Component_HTML_Utils.maybeElem(icon)(function (ic) {
                      return Halogen_HTML_Elements.i([ Component_HTML_Utils.css(ic) ])([  ]);
                  }), Halogen_HTML_Core.text(s) ];
              };
          };
          var renderLink$prime = function (link1) {
              if (link1.value0 instanceof Data_Link.SafeLink) {
                  return Component_HTML_Utils.safeHref(link1.value0.value0);
              };
              if (link1.value0 instanceof Data_Link.ExternalLink) {
                  return Halogen_HTML_Properties.href(link1.value0.value0);
              };
              throw new Error("Failed pattern match at Component.HTML.Header (line 52, column 9 - line 54, column 61): " + [ link1.constructor.name ]);
          };
          return Halogen_HTML_Elements.div([ Component_HTML_Utils.css("link") ])([ (function () {
              if (link.value0 instanceof Data_Link.SafeLink) {
                  return Halogen_HTML_Elements.a([ renderLink$prime(new HeaderLink(new Data_Link.SafeLink(link.value0.value0, link.value0.value1), link.value1)) ])(renderLinkChilds(link.value0.value1)(link.value1));
              };
              if (link.value0 instanceof Data_Link.ExternalLink) {
                  return Halogen_HTML_Elements.a([ renderLink$prime(new HeaderLink(new Data_Link.ExternalLink(link.value0.value0, link.value0.value1), link.value1)) ])(renderLinkChilds(link.value0.value1)(link.value1));
              };
              throw new Error("Failed pattern match at Component.HTML.Header (line 35, column 9 - line 44, column 38): " + [ link.constructor.name ]);
          })() ]);
      };
      return Halogen_HTML_Elements.div([ Component_HTML_Utils.css("header") ])([ Halogen_HTML_Elements.div([ Component_HTML_Utils.css("links") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(links)(renderLink)) ]);
  };
  var defaultHeader = (function () {
      var links = [ new HeaderLink(new Data_Link.SafeLink(Data_Route.Home.value, "reiknirit"), Data_Maybe.Nothing.value), new HeaderLink(new Data_Link.ExternalLink("https://github.com/reiknirit", "Github"), new Data_Maybe.Just("fab fa-github")), new HeaderLink(new Data_Link.ExternalLink("https://join.slack.com/t/fpis/shared_invite/enQtNTE0MTk3NzQ5NDc5LTY1NDgyNjJkOTc4ZmM1YTU5OGFjMGVlZjA2Njc1YWFkNWNlNGQ0M2E0ZjBiYjhkYzRhMDIxYzBlMzc3ZDA2MzI", "Slack"), new Data_Maybe.Just("fab fa-slack")), new HeaderLink(new Data_Link.ExternalLink("https://www.facebook.com/groups/reykjavikfp/", "Facebook"), new Data_Maybe.Just("fab fa-facebook")) ];
      return header(links);
  })();
...
(function($PS) {
  ...
  var Component_HTML_Footer = $PS["Component.HTML.Footer"];
  var Component_HTML_Header = $PS["Component.HTML.Header"];
  var Component_HTML_Utils = $PS["Component.HTML.Utils"];
  var Data_Function = $PS["Data.Function"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_Component = $PS["Halogen.Component"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Component_HTML_Utils.css("main-container") ])([ Component_HTML_Header.defaultHeader, Halogen_HTML_Elements.div([ Component_HTML_Utils.css("content") ])([ Halogen_HTML_Elements.div([ Component_HTML_Utils.css("iframe-container") ])([ Halogen_HTML_Elements.iframe([ Halogen_HTML_Properties.src("https://calendar.google.com/calendar/embed?src=jaoemtr4v536qd567gi89agbug%40group.calendar.google.com&ctz=Atlantic%2FReykjavik") ]) ]) ]), Component_HTML_Footer.footer ]);
      };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      var environment = {
          logLevel: AppM.Development.value,
          baseUrl: "http://localhost:8080"
      };
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM(environment))(Component_Router.component(AppM.monadAffAppM)(AppM.navigateAppM));
